...
public abstract class Interfaz extends Color{
   ...
   * Retardo en la partida.
   */
  public static void retrasoPartidaX2() {
    retrasoPartida();
    retrasoPartida();
  }
   ...
   * Resultado del juego.
   */
  public static void victoriaJugador() {
    System.out.println("\n" + YELLOW + "El ganador es el jugador 🎉" + RESET + "\n");
  }

  /**
   * Resultado del juego.
   */
  public static void victoriaMaquina() {
    System.out.println("\n" + BLUE + "El ganador es la maquina 😭" + RESET + "\n");
  }
